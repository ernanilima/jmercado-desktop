...
public class PopUpConfirmacaoController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        // ACOES EM BOTOES
        btnSim.setOnAction(e -> clicadoSim());
        btnNao.setOnAction(e -> clicadoNao());
    }
    ...
    public void exibirPopUp(CoresPopUpConfirmacao corParaSimNao, String mensagem) {
        try {
            ...
            STAGE.setOnCloseRequest(e -> clicadoNao());
    ...
    /** Quando clicado no botao sim */
    private void clicadoSim() {
        RESULTADO = true;
        sair();
    }

    /** Quando clicado no botao nao ou fechar o dialog */
    private void clicadoNao() {
        RESULTADO = false;
        sair();
    }
