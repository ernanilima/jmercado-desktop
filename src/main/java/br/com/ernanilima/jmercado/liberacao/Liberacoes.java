...
public enum Liberacoes {
    ...
    CADASTROS_USUARIOS_USUARIOS_RESENHAOUTRO(1256,1251, "RESETAR SENHA DE OUTRO USUÁRIO"),
    CADASTROS_USUARIOS_USUARIOS_RESENHAPROPRIO(1256,1251, "RESETAR SENHA DO PRÓPRIO USUÁRIO");
